...
import DefaultDropdown1 from '@/components/dropdown3'
...
export default function Home() {
    return (
      ...
      <div className='bg-bekgron3 w-screen   '>
        ...
        <div >
        <p className='text-center md:text-9xl text-rose-700 md:pt-12 sm:pt-32 font-bold sm:text-7xl text-6xl pt-32  '>ALBUM</p>  
        </div>
