...
import DefaultDropdown1 from '@/components/dropdown2'
...
export default function Home() {
    return (
      ...
      <div >
        <p className='text-center md:text-9xl text-rose-700 md:pt-12 sm:pt-12 font-bold sm:text-8xl text-5xl pt-8'>ALL SONG</p>  
        </div>
